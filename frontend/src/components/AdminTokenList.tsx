      ...
      {tokens.length === 0 ? (
        <Card className="p-8">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-medium text-pierre-gray-900 mb-2">No admin tokens found</h3>
            <p className="text-pierre-gray-600 mb-4 max-w-md">
              Create your first admin token to start provisioning API keys for users.
            </p>
