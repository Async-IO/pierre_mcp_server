...
async fn test_tool_get_activities_synthetic() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("get_activities", json!({
            "provider": "synthetic",
            "limit": 5
        }))
        .await?;
...
async fn test_tool_analyze_training_load() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("analyze_training_load", json!({
            "provider": "synthetic",
            "days": 7
        }))
        .await?;
...
async fn test_tool_calculate_fitness_score() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("calculate_fitness_score", json!({
            "provider": "synthetic"
        }))
        .await?;
...
async fn test_tool_generate_recommendations() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("generate_recommendations", json!({
            "provider": "synthetic"
        }))
        .await?;
...
async fn test_tool_analyze_performance_trends() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("analyze_performance_trends", json!({
            "provider": "synthetic",
            "days": 30
        }))
        .await?;
...
async fn test_tool_detect_patterns() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("detect_patterns", json!({
            "provider": "synthetic",
...
async fn test_tool_predict_performance() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("predict_performance", json!({
            "provider": "synthetic",
...
async fn test_tool_set_goal() -> Result<()> {
    ...
    match result {
        ...
        Err(e) => println!("✅ set_goal (error handled): {}", e.to_string().chars().take(60).collect::<String>()),
    }
    Ok(())
}
...
async fn test_tool_suggest_goals() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("suggest_goals", json!({
            "provider": "synthetic"
        }))
        .await?;
...
async fn test_tool_track_progress() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("track_progress", json!({
            "goal_id": "latest"
        }))
        .await?;
...
async fn test_tool_get_configuration_profiles() -> Result<()> {
    ...
    assert!(!result.is_error, "get_configuration_profiles should succeed");
...
async fn test_tool_calculate_personalized_zones() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("calculate_personalized_zones", json!({
            "vo2_max": 50.0
        }))
        .await?;
...
async fn test_tool_analyze_sleep_quality() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("analyze_sleep_quality", json!({
            "provider": "synthetic",
            "days": 7
        }))
        .await;
    ...
    match result {
        ...
        Err(e) => println!("✅ analyze_sleep_quality (error handled): {}", e.to_string().chars().take(60).collect::<String>()),
    }
    Ok(())
}
...
async fn test_tool_calculate_recovery_score() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("calculate_recovery_score", json!({
            "provider": "synthetic"
        }))
        .await?;
...
async fn test_tool_suggest_rest_day() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("suggest_rest_day", json!({
            "provider": "synthetic"
        }))
        .await?;
...
async fn test_tool_get_nutrient_timing() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("get_nutrient_timing", json!({
    ...
    match result {
        ...
        Err(e) => println!("✅ get_nutrient_timing (error handled): {}", e.to_string().chars().take(60).collect::<String>()),
    }
    Ok(())
}
...
async fn test_tool_search_food() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("search_food", json!({
            "query": "banana",
            "limit": 5
        }))
        .await?;
...
async fn test_tool_get_recipe_constraints() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("get_recipe_constraints", json!({
...
async fn test_tool_list_recipes() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("list_recipes", json!({}))
        .await?;
...
async fn test_tool_recipe_save_and_get() -> Result<()> {
    ...
    let save_result = client
        .call_tool_raw("save_recipe", json!({
    ...
    match save_result {
        ...
        Err(e) => println!("✅ save_recipe (error handled): {}", e.to_string().chars().take(60).collect::<String>()),
    }
    Ok(())
}
...
async fn test_tool_search_recipes() -> Result<()> {
    ...
    let result = client
        .call_tool_raw("search_recipes", json!({
            "query": "smoothie"
        }))
        .await?;
...
async fn test_tool_fitness_config_crud() -> Result<()> {
    ...
    let set_result = client
        .call_tool_raw("set_fitness_config", json!({
    ...
    match set_result {
        ...
        Err(e) => println!("✅ set_fitness_config (error handled): {}", e.to_string().chars().take(60).collect::<String>()),
    }
    ...
    match list_result {
        ...
        Err(e) => println!("✅ list_fitness_configs (error handled): {}", e.to_string().chars().take(60).collect::<String>()),
    }

    // Get specific config
    let get_result = client
        .call_tool_raw("get_fitness_config", json!({
            "configuration_name": "test_zones"
        }))
        .await;
    ...
    match get_result {
        ...
        Err(e) => println!("✅ get_fitness_config (error handled): {}", e.to_string().chars().take(60).collect::<String>()),
    }
...
async fn test_tool_missing_required_params() -> Result<()> {
    ...
    match result {
        ...
        Err(e) => {
            println!("✅ Missing params rejected: {}", e.to_string().chars().take(60).collect::<String>());
        }
    }
...
async fn test_tool_invalid_param_values() -> Result<()> {
    ...
    match result {
        ...
        Err(e) => {
            println!("✅ Invalid param rejected: {}", e.to_string().chars().take(60).collect::<String>());
        }
    }
