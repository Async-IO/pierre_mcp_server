...
echo ""
echo "For Firebase Hosting deployment, configure Workload Identity Federation"
echo "between GitHub Actions and Firebase. See:"
echo "  https://github.com/FirebaseExtended/action-hosting-deploy#setup"
echo ""
