...
pub struct UserPhysiologicalProfile {
    ...
    pub fitness_level: pierre_mcp_server::configuration::profiles::FitnessLevel,
...
impl UserPhysiologicalProfile {
    ...
    pub const fn new(user_id: Uuid, primary_sport: SportType) -> Self {
        Self {
            ...
            age: None,
            weight: None,
            fitness_level: pierre_mcp_server::configuration::profiles::FitnessLevel::Recreational,
            primary_sport,
    ...
    #[must_use]
    pub fn fitness_level_from_vo2_max(&self) -> pierre_mcp_server::configuration::profiles::FitnessLevel {
        self.vo2_max.map_or(self.fitness_level, |vo2_max| {
            pierre_mcp_server::configuration::profiles::FitnessLevel::from_vo2_max(
