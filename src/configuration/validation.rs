...
mod tests {
    ...
    fn test_validator_creation() {
        ...
        assert!(!validator.safety_rules.is_empty());
        assert!(!validator.relationship_rules.is_empty());
    }
    ...
    fn test_vo2_max_requirement() {
        ...
        let profile = UserPhysiologicalProfile {
            ...
            age: Some(30),
            weight: Some(70.0),
            fitness_level: crate::configuration::profiles::FitnessLevel::Intermediate,
            primary_sport: crate::models::SportType::Run,
