    ...
    async fn initialize_definitions(&self) {
        ...
        Self::add_definition(
            ...
            ParameterDefinition {
                ...
                env_variable: Some("RATE_LIMIT_FREE_BURST".to_owned()),
        ...
        Self::add_definition(
            ...
            ParameterDefinition {
                ...
                units: Some("requests".to_owned()),
                scientific_basis: None,
                env_variable: Some("RATE_LIMIT_PRO_BURST".to_owned()),
                is_runtime_configurable: true,
                requires_restart: false,
            },
        );
        ...
        Self::add_definition(
            ...
            ParameterDefinition {
                ...
                units: Some("requests".to_owned()),
                scientific_basis: None,
                env_variable: Some("RATE_LIMIT_ENT_BURST".to_owned()),
                is_runtime_configurable: true,
                requires_restart: false,
            },
        );
            ...
            let params: Vec<AdminConfigParameter> = definitions
                ...
                .map(|def| {
                    let full_key = format!(
                        "{}.{}",
                        def.category,
                        def.key.split('.').next_back().unwrap_or(&def.key)
                    );
